...
class TestCNNEncoder(unittest.TestCase):
  ...
  def test_get_dimenstion_is_correct(self):
    encoder = CNNEncoder(embedding_dim=5, num_filters=4, ngram_filters_sizes=(3, 5))
  ...
  def test_forward_runs_with_larger_input(self):
    encoder = CNNEncoder(
      embedding_dim=7, num_filters=13, ngram_filter_sizes=(1, 2, 3, 4, 5), output_idm=30)
